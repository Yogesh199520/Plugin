...
<?php
    ...
    if(!empty($font_size)){
        echo '<style>.smpnav ul.smpnav-menu.smpnav-targets-text-small li.menu-item>.smpnav-target{font-size:'.$font_size.'px!important;}</style>';
    } 
    if(!empty($font_family)){
        echo '<style>a.smpnav-target{font-family:"'.$font_family.'"!important;}</style>';
    }
    if(!empty($background_color)){
       echo '<style>#smpnav-toggle-main{background-color: '.$background_color.'!important;} </style>';
    }
    if(!empty($text_color)){
       echo '<style>.smpnav ul.smpnav-menu.smpnav-targets-text-large li.menu-item>.smpnav-target{color:'.$text_color.'!important;}</style>';
