...
function smpnav_get_settings_fields()
{
    ...
    $hint = '
            ...
            '</div>
            <div class="smpnav-desc-row">
                <span class="smpnav-code-snippet-type">HTML</span> <code class="smpnav-highlight-code">&lt;a class="smpnav-toggle smpnav-toggle-button" data-smpnav-target="'.$menu.'"&gt;&lt;i class="fa fa-bars"&gt;&lt;/i&gt; Toggle Menu &lt;/a&gt;</code>
            </div>';
