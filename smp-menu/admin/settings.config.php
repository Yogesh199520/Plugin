    ...
    $fields = array(
        ...
        $prefix . 'smpnav-main' => array(
            ...
            40 => array(
                ...
                'customizer' => true,
                //'customizer_section' => SMPNAV_PRO ? 'styles_panel' : 'config',
            ) ,
        ...
        $prefix . 'togglebar' => array(
            ...
            50 => array(
                ...
                'label' => __('Background Color', 'smpnav') ,
                'desc' => __('', 'smpnav') ,
                'type' => 'color',
            ...
            90 => array(
                ...
                'desc' => __('By default, smpnav will automatically determine if a gap is needed - in short, space is left for the full bar toggle, and is not left for a burger-only toggle.  If you wish to override this, you can do so here.', 'smpnav') ,
                'type' => 'radio',
                'options' => array(
